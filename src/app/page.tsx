  ...
  return (
    <main className="min-h-screen bg-[#FBFBFA]">
      ...
      <section className="relative w-full min-h-[520px] md:min-h-[620px] flex items-center overflow-hidden bg-[#FBFBFA]">
        ...
        {/* Full-Bleed Original Highland Sheep Image Layer */}
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          />
          {/* Subtle Masking Overlay: Reduced to /30 so the sheep and mountains are fully visible */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#FBFBFA] via-[#FBFBFA]/30 to-transparent md:bg-gradient-to-r md:from-[#FBFBFA] md:via-[#FBFBFA]/40 md:to-transparent" />
        </div>
      ...
      <section className="bg-white border-y border-[#E5E7EB] py-6 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-zinc-100">
          ...
          {/* Verified Listings - Brand Green Shield */}
          ...
          {/* Supervised Viewings - Brand Green Users */}
          ...
          {/* Direct WhatsApp Support - Authentic Brand Green WhatsApp Icon */}
