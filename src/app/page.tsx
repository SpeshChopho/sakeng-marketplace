  ...
  return (
    <main className="min-h-screen bg-[#FBFBFA]">
      ...
      <section className="relative w-full min-h-[500px] md:min-h-[580px] flex items-center overflow-hidden bg-[#FBFBFA]">
        ...
        {/* Full-Bleed Background Image (Exact Portrait Image from your link) */}
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          />
          {/* Vertical white gradient overlay masking text zone at 60% opacity */}
        ...
        {/* Content Container */}
        <div className="relative max-w-7xl mx-auto w-full px-6 pt-12 pb-6 md:pt-20 md:pb-8 z-10 grid grid-cols-1 md:grid-cols-2">
      ...
      {/* ================= TRUST / FEATURES SECTION (TIGHTLY ALIGNED) ================= */}
      <section className="bg-white border-y border-[#E5E7EB] pt-8 pb-10 px-6">
        <div className="max-w-7xl mx-auto">
          
          {/* Section Heading */}
          <h3 className="text-xs font-black uppercase tracking-widest text-[#6D8077] mb-6">
            Why Choose Sakeng
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-zinc-100">
